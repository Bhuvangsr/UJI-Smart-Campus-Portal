...
String visitor = request.getParameter("visitor");
		 boolean visituser;
		 if("v".equalsIgnoreCase(visitor)){
			 visituser=true;
		 }else{
			 visituser=false;
		 }
		// System.out.println(request.getParameter("visitor"));
		 //System.out.println("param: "+ParamUtil.getString(request, "visitor"));
	...
	<aui:fieldset column="<%= true %>">
		...
		<c:if test="<%= !visituser%>">
			...
			<div class="exp-ctrl-holder">
				<liferay-ui:custom-attribute className="<%= User.class.getName() %>" classPK="<%= 0 %>" editable="<%= true %>" label="<%= true %>" name="UserRole"/>
			</div>
			<div class="exp-ctrl-holder">
				<liferay-ui:custom-attribute className="<%= User.class.getName() %>" classPK="<%= 0 %>" editable="<%= true %>" label="<%= true %>" name="ChooseBuildingID"/>
			</div>
			</c:if>
