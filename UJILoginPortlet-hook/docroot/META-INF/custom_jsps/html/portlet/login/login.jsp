...
<%@ include file="/html/portlet/login/init.jsp" %>
  ...
  <aui:fieldset label="Universitat Jaume I Smart Campus Portal"></aui:fieldset> 
...
<c:choose>
	...
	<c:otherwise>
		<img src="http://uji.maps.arcgis.com/sharing/rest/portals/self/resources/banner.png"></img>
		<aui:fieldset label="UJI Portal Sign In">
		<aui:layout>
		...
		<aui:fieldset label="For Visitors of UJI">
		<aui:layout>
  		<aui:button-row>
		<aui:a href="/web/guest/landingpage?ujiVisitor=abc3" class=" taglib-icon" id="_58_visitor1" role="menuitem"><span class="taglib-text ">To Access Without Registering</span></aui:a>
			</aui:button-row>	
			<aui:button-row>
			<aui:a href="/web/guest/landingpage?p_p_id=58&p_p_lifecycle=0&p_p_state=maximized&p_p_mode=view&p_p_col_id=column-2&p_p_col_count=5&saveLastPath=false&_58_struts_action=%2Flogin%2Fcreate_account&_58_visitor=v" class=" taglib-icon" id="_58_visitor2" role="menuitem"><span class="taglib-text ">Visitor? Do You Want to Register? Click Here</span></aui:a>
			</aui:button-row>
		</aui:layout>
		</aui:fieldset>
		</aui:column>
		...
		<aui:fieldset label="For Univerity Jaume I Users">
		<aui:layout>
