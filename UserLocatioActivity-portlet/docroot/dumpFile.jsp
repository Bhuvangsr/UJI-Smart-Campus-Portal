...
<script type="text/JavaScript">
  ...
  <h4>Show the places visited in the campus on Map</h4><aui:button name="ShowPoints" value="ShowPoints" onClick="showPointsOnMap();"></aui:button>
  <h4 id="trackPathText" style="display:none">Track the places visited in the campus on Map according to time visited</h4><aui:button id="trackPath" style="display:none" value="TrackPath" onClick="trackPathPoints();"></aui:button>
